...
- Através de uma reatribuição de valor, faça com que o 2º item do array "brazilianFoods" (null) seja substituído por "Pão de Queijo";
...
- Armazene em uma const "foodsInfo" a seguinte string: "Até aqui, o array "brazilianFoods" possui NUMERO_DE_ITENS itens: NOME_DO_ITEM_1,  
...
- Armazene um array com os itens "Chico" e "Zeca" em uma const "maleDogNames";
...
- Exiba no console o último item do array "dogNames", mas de forma que caso a quantidade de itens do array aumente ou diminua,  
...
*/
dogNames.push("Nina");
 const initials  = `${dogNames[0][0]} ${dogNames[2][0]} ${dogNames[3][0]}`
...
- Utilize o método adequado para isso.s
*/
...
- Declare uma const "dessert" e faça com que ela receba uma template string que contém a parte "co" do 1º item do array "dogNames", a  
...
- Entre a declaração da "oddNumbers" e a exibição do 2º item do array elevado ao cubo, faça o 2º item do array receber todo o valor que ele  
já tem, mais 4;
